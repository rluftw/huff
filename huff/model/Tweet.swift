...
struct Tweet {
    ...
    init(tweetDict: [String: AnyObject]) {
        ...
        username = userDict?["screen_name"] as? String ?? "N/A"
        message = tweetDict["text"] as? String ?? "N/A"
        let dateString = tweetDict["created_at"] as! String
        dateCreated = dateFormatter.date(from: dateString)!.timeIntervalSince1970
