...
class CreditViewController: TextViewController {
    ...
    func loadTextView() {
        let attributes = [
            NSAttributedString.Key.font: UIFont(name: "RobotoMono-Bold", size:12)!,
    ...
    func addIconAttributes(text: inout NSMutableAttributedString, attributes: [NSAttributedString.Key: Any])  {
